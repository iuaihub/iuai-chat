...
We are excited to announce that the highly anticipated IuaiChat knowledge base feature is now officially launched! 🎉 This feature is now available in both the open-source version and the Cloud version (iuaihub.com).
...
All features are open-sourced on the [GitHub repository](https://github.com/lobehub/lobe-chat). We invite you to visit [IuaiChat Cloud](http://iuaihub.com) to experience the full functionality.
