---
title: >-
  IuaiChat Launches Knowledge Base Feature: A New Experience in Intelligent File
  Management and Dialogue
description: >-
  IuaiChat introduces a brand new knowledge base feature that supports all types
...
We are excited to announce that the highly anticipated IuaiChat knowledge base feature is now officially launched! 🎉 This feature is now available in both the open-source version and the Cloud version (lobechat.com).
...
All features are open-sourced on the [GitHub repository](https://github.com/lobehub/lobe-chat). We invite you to visit [IuaiChat Cloud](http://lobechat.com) to experience the full functionality.
