---
title: IuaiChat Plugin Ecosystem - Functionality Extensions and Development Resources
description: >-
  Discover how the IuaiChat plugin ecosystem enhances the utility and
  flexibility of the IuaiChat assistant, along with the development resources
  and plugin development guidelines provided.
---

# Supported Plugin System

The IuaiChat plugin ecosystem is a significant extension of its core functionalities, greatly enhancing the utility and flexibility of the IuaiChat assistant.

<Video src="https://github.com/iuaihub/iuai-chat/assets/28616219/f29475a3-f346-4196-a435-41a6373ab9e2" />

By leveraging plugins, the IuaiChat assistants are capable of accessing and processing real-time information, such as searching online for data and providing users with timely and relevant insights.
